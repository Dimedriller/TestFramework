...
class WebElementWait extends FluentWait<WebElement> {
    final static long DEFAULT_SLEEP_TIMEOUT = 500;

    WebElementWait(WebElement element, long timeOutInSeconds) {
        this(element, new SystemClock(), Sleeper.SYSTEM_SLEEPER, timeOutInSeconds, DEFAULT_SLEEP_TIMEOUT);
    }

    WebElementWait(WebElement element, long timeOutInSeconds, long sleepInMillis) {
